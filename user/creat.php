<div class="container container-fluid">
    <h1 class="text-center" style="margin-top: 100px;">Criar conta
        <hr>
    </h1>
            ...
            <div class="card-body">
                <form class="row g-3">
                    <div class="text-center">
                        ...
                        <label class="mt-5 btn btn-primary" for="img_perfil">Adicionar foto de perfil</label>
                    ...
                    <div class="col-12 text-center">
                        <div class=" d-grid gap-2 col-6 mx-auto">
                            <button type="submit" id="submit-form-create" class="btn btn-primary">Cadastrar</button>
                            <a href="">Já tem conta? faça login agora mesmo.</a>
                        </div>
                    </div>
                </form>
            </div>
